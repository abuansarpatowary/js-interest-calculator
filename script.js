...
const numberOfYear = document.querySelector(
  ".input-box-wrapper .number-of-year"
);
const interestBtn = document.querySelector(".interest-btn");
const interestValue = document.querySelector(
  ".input-box-wrapper .interest-rate"
);
...
const amountValue = () => {
  document.querySelector(".input-box-wrapper .amount-value").innerText =
    amount.value;
};
...
const interestRateValue = () => {
  document.querySelector(".input-box-wrapper .interest-rate-value").innerText =
    interestValue.value;
};
...
const calculateInterest = () => {
  totalAmountCalculate =
    (parseInt(amount.value) * parseInt(numberOfYear.value) * parseInt(interestValue.value)) / 100;
  document.querySelector(".total-interest span").innerText =
    totalAmountCalculate;
